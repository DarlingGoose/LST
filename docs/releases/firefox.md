...
- Reviewer notes: [`amo-reviewer-notes.md`](amo-reviewer-notes.md)
...
6. Paste `docs/releases/amo-reviewer-notes.md` into Notes for Reviewers.
...
1. Updates `src/manifest.json`, `package.json`, and both version fields in `package-lock.json` together.
